...
void UIElement::AddUIObject(SDL_Texture *texture, Point pos, Point texSize, double rotation)
{
	// Adds an object to the list.
	m_objList.push_back(new Object(texture, pos, texSize, rotation));
}

// This function renders the child objects
